        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tr>
                        <th>الصورة</th>
                        <th>الاختصاص باللغة العربية</th>
                        <th>الاختصاص باللغة الانجليزية</th>
                        <th>الاختصاص باللغة الكردية</th>
                        <th>التحكم</th>
                    </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <div class="modal fade" id="specialization{{$specializationn->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="specializationLabel{{$specializationn->id}}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                <div class="modal-header backgroundColor text-white" style="border:none">
                                    <h5 class="modal-title" style="color: black" id="specializationLabel{{$specializationn->id}}">الصورة</h5>
