    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h5 class="mb-5 mt-3">تعديل الاختصاص {{$specialization->Title_ar}}</h5>

                <form method="post" action="{{route('specializations.update',['specialization'=>$specialization->id])}}">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">المدينة باللغة العربية</label>
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$specialization->Title_ar}}" name="Title_ar" type="text" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$specialization->Title_en}}" name="Title_en" type="text" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$specialization->Title_ku}}" name="Title_ku" type="text" id="example-text-input">
                        </div>
                    </div>
