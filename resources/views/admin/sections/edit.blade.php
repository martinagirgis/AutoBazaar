    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h5 class="mb-5 mt-3">تعديل قسم {{$section->Title_ar}}</h5>
                ...
                <form method="post" action="{{route('sections.update',['section'=>$section->id])}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$section->Title_ar}}" name="Title_ar" type="text" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$section->Title_en}}" name="Title_en" type="text" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$section->Title_ku}}" name="Title_ku" type="text" id="example-text-input">
                        </div>
                    </div>
